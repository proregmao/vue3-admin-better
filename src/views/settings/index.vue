        ...
        <el-tab-pane label="基本设置" name="basic">
          ...
          >
            ...
            <el-form-item label="底部版权信息" prop="copyright">
              <el-input v-model="basicForm.copyright" type="textarea" :rows="2" />
            </el-form-item>
  ...
  data() {
    return {
      ...
      basicForm: {
        ...
        copyright: localStorage.getItem("vab-copyright") || "Copyright vue3-admin-better 开源免费版 2025"
      },
      securityForm: {
        minPasswordLength: 8,
        twoFactorAuth: false,
  ...
  methods: {
    ...
    saveBasicSettings() {
      this.$refs.basicFormRef.validate((valid) => {
        if (valid) {
          localStorage.setItem("vab-copyright", this.basicForm.copyright);
          // 使用 eventBus 通知其他组件更新
          if (this.$eventBus) {
             this.$eventBus.emit("update-copyright", this.basicForm.copyright);
          } else if (window.$eventBus) {
             window.$eventBus.emit("update-copyright", this.basicForm.copyright);
          }
